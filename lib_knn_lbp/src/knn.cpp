...
// Construtor
knn::knn(const std::string& metric)
...
double knn::euclidean_distance(const arma::rowvec& a,
    const arma::rowvec& b)
{
...
double knn::manhattan_distance(const arma::rowvec& a,
    const arma::rowvec& b)
{
...
double knn::minkowski_distance(const arma::rowvec& a, const arma::rowvec& b,
    double p)
{
...
double knn::calculate_distance(const arma::rowvec& a,
    const arma::rowvec& b)
{
...
void knn::fit(const std::vector<data_point>& train) { train_data = train; }

// Método 'predict' para fazer previsões
std::vector<int> knn::predict(const std::vector<data_point>& test_data,
    int k)
{
...
int knn::classify(const data_point& test_point, int k)
{
 ...
 */
void say_hello() { std::cout << "Hello, from knn!\n"; }
